...
header = 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36'
while(1):
    ...
    req = urllib.request.Request(url, date, header)
    response = urllin.request.urlopen(req)
